...
public class GeTuiIntentService extends GTIntentService {
    ...
    @Override public void onNotificationMessageArrived(Context context, GTNotificationMessage message) {
    ...
    private void bindAliasResult(BindAliasCmdMessage bindAliasCmdMessage) {
        ...
        Log.d(TAG, "bindAlias result sn = " + sn + ", code = " + code + ", text = " + text);
    }
    ...
    private void unbindAliasResult(UnBindAliasCmdMessage unBindAliasCmdMessage) {
        ...
        Log.d(TAG, "unbindAlias result sn = " + sn + ", code = " + code + ", text = " + text);
    }
