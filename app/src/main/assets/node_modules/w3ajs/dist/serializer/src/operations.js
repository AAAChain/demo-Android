...
var data_asset_create = exports.data_asset_create = new Serializer("data_asset_create", { fee: asset,
    ownerId: protocol_id_type("account"),
    url: string,
    data_desc: string,
    data_hash: uint16,
    data_key: uint16,
...
var data_asset_update = exports.data_asset_update = new Serializer("data_asset_update", {
    fee: asset,
    ownerId: protocol_id_type("account"),
    owner: authority,
    active: authority
